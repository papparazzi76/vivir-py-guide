...
export const SCHOOLS: School[] = [
  // Nivel 1: Élite Internacional
  {
    ...
    ranking: 5,
    description: 'Comunidad de aprendizaje bilingüe que sigue estándares educativos de EE.UU. y Paraguay. Más de 30 nacionalidades. Puerta de entrada a universidades estadounidenses.',
    tuition: '$8,806 USD/año',
    category: 'elite',
  },
  {
    id: '2',
    name: 'Colegio Internacional SEK Paraguay',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Parte de la Institución Internacional SEK con presencia global. Educación trilingüe y programa de Bachillerato Internacional (IB).',
    tuition: 'G. 25.655.000 (solicitud)',
    category: 'elite',
  },
  {
    id: '3',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Principal institución educativa alemana en Paraguay. Educación bicultural con opción de Bachillerato Internacional (GIB). Ranking OMAPA 2014: #6.',
    tuition: 'Muy Alto',
    category: 'elite',
  },
  {
    id: '4',
    name: 'San Ignacio de Loyola (SIL)',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Institución de alta exigencia académica con enfoque integral. Ofrece programa de Bachillerato Internacional. Consistentemente entre las más prestigiosas del país.',
    tuition: 'Muy Alto',
    category: 'elite',
  },
  // Nivel 2: Élite Tradicional
  {
    id: '5',
    ...
    ranking: 5,
    description: 'Fundado en 1904, una de las instituciones católicas privadas con mayor relevancia histórica. Ranking OMAPA 2014: #2. Certificaciones internacionales de Cambridge.',
    tuition: 'Alto',
  ...
  },
  {
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Fundado en 1920, institución tradicional con fuerte base de principios cristianos. Su misión se centra en formar líderes con vocación de servicio.',
    tuition: 'Alto',
    category: 'traditional',
  },
  {
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Ranking OMAPA 2014: #1 en colegios privados. Prestigio basado en excelencia académica, especialmente en ciencias y matemáticas.',
    tuition: 'Alto',
    category: 'traditional',
  },
  {
    id: '8',
    name: 'Colegio Campoalto',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Institución católica de prestigio con más de 40 años de historia. Ranking OMAPA 2014: #5. Combina formación en valores con exigencia educativa.',
    tuition: 'Alto',
    category: 'traditional',
  },
  {
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 4,
    description: 'Institución italiana con educación bilingüe. Costos 2024: matrícula desde G. 1.318.000, cuota mensual desde G. 1.281.000.',
    tuition: 'G. 1.318.000 - G. 1.974.000',
    category: 'traditional',
  },
  // Nivel 3: Alto Rendimiento
  {
    id: '10',
    name: 'CEPB (Colegio Experimental Paraguay Brasil)',
    ...
    levels: ['Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Institución pública dependiente de la UNA. Nivel de prestigio comparable a privados de Nivel 1. Bilingüismo español-portugués. Ranking OMAPA 2014 Públicos: #6. Requiere examen de ingreso.',
    tuition: 'Público',
    category: 'accessible',
  },
  {
    id: '11',
    name: 'Salesianito (Sagrados Corazones)',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 4,
    description: 'Institución católica con bachilleratos técnicos. Extraordinario dominio deportivo (campeonatos JEEN 2024). Costos 2024: matrícula desde G. 950.000.',
    tuition: 'G. 820.000 - G. 985.000/mes',
    category: 'accessible',
  },
  {
    id: '12',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 4,
    description: 'Colegio bilingüe de alta calidad. Citado como muy buena escuela bilingüe fuera del segmento de Nivel 1.',
    tuition: 'Medio-Alto',
    category: 'traditional',
  },
  // Ciudad del Este
  {
    id: '13',
    name: 'Berta International School (BIS)',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Líder en bilingüismo de alto nivel en Alto Paraná. Única institución que prepara para certificaciones C1 Advanced y C2 Proficiency de Cambridge. Método Singapur y Phonics.',
    tuition: 'Alto',
    category: 'elite',
  },
  {
    id: '14',
    name: 'Instituto Cristiano Interactivo (ICI)',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 5,
    description: 'Principal opción para educación de élite con valores cristianos. Acreditación ACSI. Método de Matemática Singapur.',
    tuition: 'Alto',
    category: 'elite',
  },
  {
    id: '15',
    name: 'Colegio Crecer (CRECE)',
    ...
    levels: ['Preescolar', 'Primaria', 'Secundaria'],
    ranking: 4,
    description: 'Paquete integral de educación moderna con metodologías innovadoras y enfoque en desarrollo integral del estudiante.',
    tuition: 'Medio-Alto',
    category: 'traditional',
  },
];
