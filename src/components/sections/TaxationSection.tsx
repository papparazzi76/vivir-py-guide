            ...
            <Card className="mb-8 bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 shadow-lg">
              ...
              <CardContent>
                <p className="text-lg text-foreground">
                  Paraguay se rige por el <strong>Principio de la Fuente</strong>. Esto significa que, en general, solo se gravan las rentas generadas <strong>dentro</strong> de las fronteras del país.
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start space-x-3">
                    <Icon name="check" className="text-green-600 mt-1 flex-shrink-0" />
                    <p><strong>Impuesto 0% sobre rentas extranjeras:</strong> Salarios por trabajo remoto para empleadores extranjeros, dividendos de empresas foráneas o intereses bancarios en el exterior no están sujetos a impuestos en Paraguay.</p>
                  </li>
                </ul>
              </CardContent>
            </Card>
          ...
          <AnimatedDiv delay={200}>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="bg-white rounded-xl shadow-lg px-6">
                ...
                <AccordionContent className="space-y-4 pt-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-2">Grava rentas pasivas de <strong>fuente paraguaya</strong> (alquileres, intereses locales).</p>
                    <ul className="list-disc pl-5 text-sm space-y-1">
                      <li><strong>Tasa Única:</strong> 8% sobre la Renta Neta.</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="bg-white rounded-xl shadow-lg px-6 mt-4">
                ...
                <AccordionContent className="space-y-4 pt-2">
                  ...
                  <ul className="list-disc pl-5 text-sm space-y-1">
                    ...
                    <li><strong>Tasa Reducida:</strong> 5% para alquileres de vivienda y ciertos bienes.</li>
                    <li><strong>¡Clave para Nómadas Digitales!:</strong> La <strong>exportación de servicios</strong> (como consultoría, desarrollo de software, etc.) a clientes del exterior está <strong>exenta de IVA</strong>.</li>
                  </ul>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3" className="bg-white rounded-xl shadow-lg px-6 mt-4">
                ...
                <AccordionContent className="space-y-4 pt-2">
                  <p>Grava la <strong>distribución</strong> de ganancias de <strong>empresas paraguayas</strong> a sus accionistas.</p>
                  <ul className="list-disc pl-5 text-sm space-y-1">
                    <li><strong>Tasa para Residentes:</strong> 8%.</li>
                    <li><strong>Tasa para No Residentes:</strong> 15%.</li>
                    <li><strong>Importante:</strong> Este impuesto no aplica a dividendos recibidos de empresas extranjeras.</li>
                  </ul>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
