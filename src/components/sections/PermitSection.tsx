        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <AnimatedDiv delay={100}>
              <div className="bg-card rounded-2xl p-8 shadow-lg hover-lift">
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-2">Residencia Permanente</h3>
                    <p className="text-muted-foreground">Para establecerse a largo plazo</p>
                  </div>
                </div>
            ...
            <AnimatedDiv delay={200}>
              <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl p-8 shadow-lg hover-lift border border-primary/20">
                <div className="flex items-start space-x-4 mb-6">
                  <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                    <Icon name="shield" className="text-white" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-2">Cédula de Identidad Paraguaya</h3>
                    <p className="text-muted-foreground font-semibold">La "Llave Dorada" para la Integración Total</p>
                  </div>
                </div>
            ...
            <AnimatedDiv delay={300}>
              <div className="bg-card rounded-2xl p-8 shadow-lg overflow-x-auto">
                <h3 className="text-2xl font-bold mb-6">Comparación de Opciones</h3>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <AnimatedDiv delay={100}>
                <div className="bg-gradient-to-br from-primary to-secondary rounded-2xl p-8 shadow-xl text-white">
                  ...
                  {submitStatus === 'success' ? (
                    <div className="bg-white/20 rounded-lg p-6 text-center">
                      <Icon name="check" className="mx-auto mb-3" size={48} />
                      <p className="font-semibold">¡Mensaje enviado!</p>
                      <p className="text-sm mt-2 opacity-90">Te contactaremos pronto.</p>
                    </div>
                  ) : (
